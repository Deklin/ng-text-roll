...
gulp.task('highlightjs', ['other'], function() {
  return gulp.src(path.join(conf.paths.src, '/assets/highlightjs/**/*.{css,js}'))
  .pipe(gulp.dest(path.join(conf.paths.dist, '/assets/highlightjs/')));
});
...
gulp.task('build', ['html', 'fonts', 'highlightjs']);
